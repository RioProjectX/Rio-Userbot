...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/bf0f71c6a3da0e96c5547.jpg"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/bf0f71c6a3da0e96c5547.jpg"
)
...
async def check_botlog_chatid() -> None:
    if not BOTLOG_CHATID and BOTLOG:
        LOGS.warning(
            "var BOTLOG_CHATID kamu belum di isi. Buatlah grup telegram dan masukan bot @Rio2Robott lalu ketik /id Masukan id grup nya di var BOTLOG_CHATID"
        )
        sys.exit(1)
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Rio-UserBot v{BOT_VER} is back up and running!**\n\n"
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@RioGroupSupport"):
                ...
                result = builder.article(
                    ...
                    text="**Rio - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [Rio](https://t.me/fckualot)\n✣ **Support :** @RioProjects\n✣ **Repository :** [Rio-Userbot](https://github.com/RioProjectx/Rio-Userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/riogroupsupport"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/RioProjectX/Rio-Userbot"
                            ),
                        ],
                    ],
                    link_preview=False,
